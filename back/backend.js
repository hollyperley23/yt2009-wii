...
app.get("/wiiapiplayer", (req, res) => {
    res.redirect("../media/wii/apiplayer.swf")
})

app.get("/wiiapiplayerfull", (req, res) => {
    res.redirect("../media/tv/wii/apiplayer-vflZLm5Vu.swf")
})

app.get("/wiiconf", (req, res) => {
    res.redirect("/s/tv/wii/config.txt")
})

app.get("/label_extension", (req, res) => {
    res.redirect("/s/tv/wii/config.txt")
})


app.get("/vast_ads_module", (req, res) => {
    res.redirect("../vast_ads_module.swf")
})

app.get("/leanback_ajax?action_featured=1&", (req, res) => {
    res.redirect("../s/tv/wii/en.txt")
})
...
app.get("/get_video", (req, res) => {
    console.log("/get_video call", req.query.video_id);
...
let tvEndpoints = ["/tv", "/tv/", "/tv/index.htm"]
